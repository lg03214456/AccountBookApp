...
<template>
  <div class="view-wrapper fade-in">
    ...
    <header class="view-header sm:flex-row flex-column gap-3 sm:align-items-end">
      ...
      <SelectButton v-model="chartType" :options="typeOptions" optionLabel="label" optionValue="value" class="custom-select-btn">
        ...
        <Card class="theme-card chart-main-card shadow-sm h-full">
          <template #content>
            <div class="flex flex-column h-full">
              ...
              <div class="total-display-box mt-4 p-3 border-round-xl">
            ...
            <template #content>
              <div v-for="(item, index) in transactions" :key="item.category" 
                ...
                <div class="text-right">
                  <div class="font-black text-xl text-red-500">$ {{ item.amount.toLocaleString() }}</div>
...
.rank-1 { background: #f59e0b; color: white; } /* 金牌 */
